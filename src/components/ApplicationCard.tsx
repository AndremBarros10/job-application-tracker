...
export function ApplicationCard({ company, role, date, hasInterview }: CardData) {
  return (
    <div className="bg-[#1E1D22] border border-[#2C2B31] rounded-[9px] py-2.5 px-[11px] cursor-grab shadow-[0_1px_2px_rgba(0,0,0,0.4)]">
